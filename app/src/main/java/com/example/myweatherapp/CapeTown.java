...
public class CapeTown extends AppCompatActivity {
    float x1, x2, y1, y2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cape_town);
    ...
    public void findWeather() {
        String url = "http://api.openweathermap.org/data/2.5/weather?q=cape%20town&appid=157b4de0b117433be579c0f828d2aa6c&units=metric";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(CapeTown.this, error.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        RequestQueue requestQueue = Volley.newRequestQueue(CapeTown.this);
    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1<x2){
                    Intent i = new Intent(CapeTown.this, Vienna.class);
                    startActivity(i);
                }else if(x1>x2) {
                    Intent i = new Intent(CapeTown.this, MainActivity.class);
                    startActivity(i);
                }
                break;
        }
