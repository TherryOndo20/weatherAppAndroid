...
public class London extends AppCompatActivity {
    ...
    public void findWeather() {
        String url = "http://api.openweathermap.org/data/2.5/weather?q=london&appid=157b4de0b117433be579c0f828d2aa6c&units=metric";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(London.this, error.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        RequestQueue requestQueue = Volley.newRequestQueue(London.this);
    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1<x2){
                    Intent i = new Intent(London.this, Rome.class);
                    startActivity(i);
                }else if(x1>x2) {
                    Intent i = new Intent(London.this, Dublin.class);
                    startActivity(i);
                }
                break;
        }
