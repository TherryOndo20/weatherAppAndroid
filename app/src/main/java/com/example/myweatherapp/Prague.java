...
public class Prague extends AppCompatActivity {
    float x1, x2, y1, y2;
    ...
    public void findWeather() {
        String url = "http://api.openweathermap.org/data/2.5/weather?q=prague&appid=157b4de0b117433be579c0f828d2aa6c&units=metric";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Prague.this, error.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        RequestQueue requestQueue = Volley.newRequestQueue(Prague.this);
    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1<x2){
                    Intent i = new Intent(Prague.this, Dublin.class);
                    startActivity(i);
                }else if(x1>x2) {
                    Intent i = new Intent(Prague.this, Vienna.class);
                    startActivity(i);
                }
                break;
        }
